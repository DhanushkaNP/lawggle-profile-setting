...
$(document).ready(async function () {
  ...
  $("#save-cases").click(async function () {
    if (lawyerState.notableCaseWins.length >= 3) {
      const errorEl = document.getElementById("case-wins-error-text");
      errorEl.style.display = "block";
      return;
    }
...
async function updateallthefields(email, member = {}) {
  try {
    ...
    if (mongodbuser.status == "true") {
      ...
      setupMediaAndPress(themediaandPress);
...
const CHECKED_IMG_URL =
  "https://cdn.prod.website-files.com/67e360f08a15ef65d8814b41/684e85957baf55c36cd79a9e_checkbox-checked-svgrepo-com%20(4).svg";
